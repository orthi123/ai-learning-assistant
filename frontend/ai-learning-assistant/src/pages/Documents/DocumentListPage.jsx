        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            <button
              ...
              className="absolute top-6 right-6 w-8 h-8 flex items-center justify-center rounded-lg text-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-all duration-200"
            >
            ...
            <form onSubmit={handleUpload} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="block text-x5 font-semibold text-slate-700 uppercase truncate-wide">
                  Document Title
                </label>
                <input
                  type="text"
              ...
              <div className="block text-xs font-semibold text-slate-700 uppercase tracking-wide">
                ...
                <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                  ...
                  <div className="flex flex-col items-center justify-center py-10 px-6">
                    ...
                    <p className="text-xs text-slate-900">PDF up to 10MB</p>
                  </div>
                </div>
              </div>
        ...
        <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
          ...
          <div className="flex gap-3 ">
            <button
              ...
              onClick={() => setIsDeleteModalOpen(false)}
              disabled={deleting}
              className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-white text-slate-700 text-sm font-semibold hover:bg-slate-50 hover:border-slate-300 transitio-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
            <button
