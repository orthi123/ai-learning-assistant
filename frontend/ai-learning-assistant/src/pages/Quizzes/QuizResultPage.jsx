      ...
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8">
        <div className="text-center space-y-6">
          ...
          <div className="flex items-center justify-center gap-4 pt-4">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounde-xl">
              <CheckCircle2
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1">
                  <div className="inline-flex gap-2 px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg mb-3">
