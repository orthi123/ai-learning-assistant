...
const RegisterPage = () => {
  const [username, setUsername] = useState(""); // U বড় হাতের করা হয়েছে
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50 relative overflow-hidden">
      {/* Background Pattern */}
