...
const FlashcardPage = () => {
  ...
  const handleReview = async (index) => {
    ...
    try {
      ...
      // toast.success("Flashcard reviewed!"); // Optional: often annoying if shown every time
    } catch (error) {
      ...
      return (
        <div className="flex flex-col items-center gap-4">
          ...
          <Button onClick={handleGenerateFlashcards} loading={generating}>
            <Plus size={16} className="mr-2" /> Generate Flashcards
          </Button>
        </div>
      );
    }
  ...
  <div className="mb-4">
    <Link
      ...
      className="inline-flex items-center gap-2 text-sm text-neutral-600 hover:text-neutral-600 transition-colors"
    >
      <ArrowLeft size={16} />
      Back to Document
    </Link>
